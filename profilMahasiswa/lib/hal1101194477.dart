...
// class hal1101194477 extends StatelessWidget {
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('M Raihan Al Ghifari'),
//       ),
//       body: Column(
//         children: [
//           Container(
...
// }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('M Raihan Al Ghifari/Page-1'),
      ),
      body: Column(
        children: [
          Container(
...
class _SecondPageState extends State<SecondPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('M Raihan Al Ghifari/Page-2'),
      ),
      body: Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pop(context, hal1101194477());
                        }),
                  ),
...
class ThirdPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('M Raihan Al Ghifari Nur Septiani/Page-3'),
        ),
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              CircleAvatar(
                ...
                backgroundImage:
                    AssetImage('lib/images/mraihanag..png'), // gambar dari assets
              ),
              Text(
                '$emailFinal',
...
class FourthPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('M Raihan Al Ghifari/Page-4'),
      ),
      body: Padding(
        padding: EdgeInsets.all(16.0),
        child: Column(
